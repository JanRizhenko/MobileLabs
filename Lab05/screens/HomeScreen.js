...
export default function HomeScreen() {
    ...
    return (
        <SafeAreaView style={homeScreenStyles.container}>
            <TouchableOpacity
                style={homeScreenStyles.fileSystemButton}
            ...
            <View style={homeScreenStyles.storageInformationContainer}>
                <Text style={homeScreenStyles.storageInformationText}>
                    Total storage space: {format_bytes(totalStorage)}
                </Text>

                <Text style={homeScreenStyles.storageInformationText}>
                    Free storage space: {format_bytes(freeStorage)}
                </Text>

                <Text style={homeScreenStyles.storageInformationText}>
                    Used storage space: {format_bytes(totalStorage - freeStorage)}
                </Text>

                <Text style={homeScreenStyles.storageInformationText}>
                    Usage: {format_percentage((totalStorage - freeStorage) / totalStorage)}
                </Text>
            </View>
        </SafeAreaView>
    );
