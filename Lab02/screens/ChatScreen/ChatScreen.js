...
export function ChatScreen()
{
    ...
    const getData = (index=0) =>
    {
        return [
            {
                id: 1 + index, username: "Stewie2K", lastMessage : "I'm already starting to play • 14 Jun", mine: false,
                profilePicture: "question_mark", unreadMessages: 1, activityColor: "green",
            },

            {
                id: 2 + index, username: "Stewie2K", lastMessage : "Ok • 14 Jun", mine: true,
                profilePicture: "question_mark", unreadMessages: 0, activityColor: "green",
            },

            {
                id: 3 + index, username: "Eminem", lastMessage : "Ok • 14 Jun", mine: true,
                profilePicture: "rust", unreadMessages: 0, activityColor: theme.buttonActive,
            },

            {
                id: 4 + index, username: "Eminem", lastMessage : "Ok • 14 Jun", mine: true,
                profilePicture: "rust", unreadMessages: 0, activityColor: theme.buttonActive,
            },

            {
                id: 5 + index, username: "Kesh", lastMessage : "Hello! • 12 Jun", mine: true,
                profilePicture: "smiley_face", unreadMessages: 0, activityColor: theme.buttonActive,
            },

            {
                id: 6 + index, username: "Kesh", lastMessage : "Hello! • 12 Jun", mine: true,
                profilePicture: "smiley_face", unreadMessages: 0, activityColor: theme.buttonActive,
            },

            {
                id: 7 + index, username: "💎∑χρŗêssσ#=_-#", lastMessage : "Ok", mine: false,
                profilePicture: "expresso", unreadMessages: 0, activityColor: theme.buttonActive,
            },

            {
                id: 8 + index, username: "💎∑χρŗêssσ#=_-#", lastMessage : "Ok", mine: false,
                profilePicture: "expresso", unreadMessages: 0, activityColor: theme.buttonActive,
            },
        ]
    }
